...
class BillingServiceTest {
    ...
    void applyAdjustments_affectsTotal_andClampsAtZero() {
        ...
        svc.applyAdjustments(bill, bd("100.00"), bd("50.00")); // total 450
        assertEquals(bd("500.00"), bill.getSubtotal());
        assertEquals(bd("450.00"), bill.getTotal());

        svc.applyAdjustments(bill, bd("1000.00"), bd("0.00")); // would go negative -> clamp 0
